    ...
    <div class="telo">
        <div class="div_kontejner centriranje">
            <div id="form_kontejner">
                <form id="forma_1" action="ubaciTvozilo.php" method="post">
                    <span id="forma_naslov">Dodajte novo transportno vozilo!</span>
                    <div>
                    ...
                    <div>
                        <input value="Dodaj Vozilo" type="submit" id="dugme_posalji">
