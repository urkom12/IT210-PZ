...
<body>
    ...
    $sql = "SELECT * FROM motori";
    $result = $con->query($sql);
    echo "<center><h2 style='margin: 30px 0px 30px 0px'>Trenutne ponude motora</h2></center><br> <p style='font-size:20px; color:white; display:block; text-align:center; margin-bottom:50px;'>Klikom na sliku automobila radite rezervaciju vozila.</p>";
