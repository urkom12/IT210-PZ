...
<body>
    ...
    <div class="telo">
        <a href="izmeniAuto.php"><img class="slikedodaj" src="../slike/auto.png" alt="auto"></a>
        <a href="izmeniMotor.php"><img class="slikedodaj" src="../slike/motor.png" alt="motor"></a>
        <a href="izmeniTvozilo.php"><img class="slikedodaj" src="../slike/tvozilo.png" alt="tvozilo"></a>
    </div>
    <footer>
        <div id="footerBlock">
